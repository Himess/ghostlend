> For the complete documentation index, see [llms.txt](https://docs.zama.org/protocol/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.zama.org/protocol/solidity-guides/v0.11/smart-contract/oracle.md).
...
```
GET https://docs.zama.org/protocol/solidity-guides/v0.11/smart-contract/oracle.md?ask=<question>&goal=<endgoal>
```
